...
def create_model():
    model = Sequential()
    model.add(Dense(20, input_dim=21, init='normal', activation='sigmoid'))
...
tournament_data['probability'] = tournament_predictions[:,1]
print(tournament_data.head())

tournament_data.to_csv("/home/machine_learning/Downloads/sub8.csv",  index=None)
