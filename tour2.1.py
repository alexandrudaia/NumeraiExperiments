...
temp=tsne(np.concatenate((trainvec,testvec)),2,10)
...
pd.DataFrame(train_pred5[:,1]).to_csv('/home/machine_learning/Downloads/sub5Train.csv',index=False)
#from sklearn.linear_model  import LogisticRegression
#from sklearn.pipeline import make_pipeline
...
sub.to_csv('/home/machine_learning/Downloads/sub5.csv',index=False)
